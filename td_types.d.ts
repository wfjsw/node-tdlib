...
export type Invoke =
  | ((method: 'getAuthorizationState', params: getAuthorizationState) => Promise<AuthorizationState>)
  | ((method: 'setTdlibParameters', params: setTdlibParameters) => Promise<Ok>)
  | ((method: 'checkDatabaseEncryptionKey', params: checkDatabaseEncryptionKey) => Promise<Ok>)
  | ((method: 'setAuthenticationPhoneNumber', params: setAuthenticationPhoneNumber) => Promise<Ok>)
  | ((method: 'resendAuthenticationCode', params: resendAuthenticationCode) => Promise<Ok>)
  | ((method: 'checkAuthenticationCode', params: checkAuthenticationCode) => Promise<Ok>)
  | ((method: 'checkAuthenticationPassword', params: checkAuthenticationPassword) => Promise<Ok>)
  | ((method: 'requestAuthenticationPasswordRecovery', params: requestAuthenticationPasswordRecovery) => Promise<Ok>)
  | ((method: 'recoverAuthenticationPassword', params: recoverAuthenticationPassword) => Promise<Ok>)
  | ((method: 'checkAuthenticationBotToken', params: checkAuthenticationBotToken) => Promise<Ok>)
  | ((method: 'logOut', params: logOut) => Promise<Ok>)
  | ((method: 'close', params: close) => Promise<Ok>)
  | ((method: 'destroy', params: destroy) => Promise<Ok>)
  | ((method: 'getCurrentState', params: getCurrentState) => Promise<Updates>)
  | ((method: 'setDatabaseEncryptionKey', params: setDatabaseEncryptionKey) => Promise<Ok>)
  | ((method: 'getPasswordState', params: getPasswordState) => Promise<PasswordState>)
  | ((method: 'setPassword', params: setPassword) => Promise<PasswordState>)
  | ((method: 'getRecoveryEmailAddress', params: getRecoveryEmailAddress) => Promise<RecoveryEmailAddress>)
  | ((method: 'setRecoveryEmailAddress', params: setRecoveryEmailAddress) => Promise<PasswordState>)
  | ((method: 'checkRecoveryEmailAddressCode', params: checkRecoveryEmailAddressCode) => Promise<PasswordState>)
  | ((method: 'resendRecoveryEmailAddressCode', params: resendRecoveryEmailAddressCode) => Promise<PasswordState>)
  | ((method: 'requestPasswordRecovery', params: requestPasswordRecovery) => Promise<EmailAddressAuthenticationCodeInfo>)
  | ((method: 'recoverPassword', params: recoverPassword) => Promise<PasswordState>)
  | ((method: 'createTemporaryPassword', params: createTemporaryPassword) => Promise<TemporaryPasswordState>)
  | ((method: 'getTemporaryPasswordState', params: getTemporaryPasswordState) => Promise<TemporaryPasswordState>)
  | ((method: 'getMe', params: getMe) => Promise<User>)
  | ((method: 'getUser', params: getUser) => Promise<User>)
  | ((method: 'getUserFullInfo', params: getUserFullInfo) => Promise<UserFullInfo>)
  | ((method: 'getBasicGroup', params: getBasicGroup) => Promise<BasicGroup>)
  | ((method: 'getBasicGroupFullInfo', params: getBasicGroupFullInfo) => Promise<BasicGroupFullInfo>)
  | ((method: 'getSupergroup', params: getSupergroup) => Promise<Supergroup>)
  | ((method: 'getSupergroupFullInfo', params: getSupergroupFullInfo) => Promise<SupergroupFullInfo>)
  | ((method: 'getSecretChat', params: getSecretChat) => Promise<SecretChat>)
  | ((method: 'getChat', params: getChat) => Promise<Chat>)
  | ((method: 'getMessage', params: getMessage) => Promise<Message>)
  | ((method: 'getMessageLocally', params: getMessageLocally) => Promise<Message>)
  | ((method: 'getRepliedMessage', params: getRepliedMessage) => Promise<Message>)
  | ((method: 'getChatPinnedMessage', params: getChatPinnedMessage) => Promise<Message>)
  | ((method: 'getMessages', params: getMessages) => Promise<Messages>)
  | ((method: 'getFile', params: getFile) => Promise<File>)
  | ((method: 'getRemoteFile', params: getRemoteFile) => Promise<File>)
  | ((method: 'getChats', params: getChats) => Promise<Chats>)
  | ((method: 'searchPublicChat', params: searchPublicChat) => Promise<Chat>)
  | ((method: 'searchPublicChats', params: searchPublicChats) => Promise<Chats>)
  | ((method: 'searchChats', params: searchChats) => Promise<Chats>)
  | ((method: 'searchChatsOnServer', params: searchChatsOnServer) => Promise<Chats>)
  | ((method: 'getTopChats', params: getTopChats) => Promise<Chats>)
  | ((method: 'removeTopChat', params: removeTopChat) => Promise<Ok>)
  | ((method: 'addRecentlyFoundChat', params: addRecentlyFoundChat) => Promise<Ok>)
  | ((method: 'removeRecentlyFoundChat', params: removeRecentlyFoundChat) => Promise<Ok>)
  | ((method: 'clearRecentlyFoundChats', params: clearRecentlyFoundChats) => Promise<Ok>)
  | ((method: 'checkChatUsername', params: checkChatUsername) => Promise<CheckChatUsernameResult>)
  | ((method: 'getCreatedPublicChats', params: getCreatedPublicChats) => Promise<Chats>)
  | ((method: 'getGroupsInCommon', params: getGroupsInCommon) => Promise<Chats>)
  | ((method: 'getChatHistory', params: getChatHistory) => Promise<Messages>)
  | ((method: 'deleteChatHistory', params: deleteChatHistory) => Promise<Ok>)
  | ((method: 'searchChatMessages', params: searchChatMessages) => Promise<Messages>)
  | ((method: 'searchMessages', params: searchMessages) => Promise<Messages>)
  | ((method: 'searchSecretMessages', params: searchSecretMessages) => Promise<FoundMessages>)
  | ((method: 'searchCallMessages', params: searchCallMessages) => Promise<Messages>)
  | ((method: 'searchChatRecentLocationMessages', params: searchChatRecentLocationMessages) => Promise<Messages>)
  | ((method: 'getActiveLiveLocationMessages', params: getActiveLiveLocationMessages) => Promise<Messages>)
  | ((method: 'getChatMessageByDate', params: getChatMessageByDate) => Promise<Message>)
  | ((method: 'getChatMessageCount', params: getChatMessageCount) => Promise<Count>)
  | ((method: 'removeNotification', params: removeNotification) => Promise<Ok>)
  | ((method: 'removeNotificationGroup', params: removeNotificationGroup) => Promise<Ok>)
  | ((method: 'getPublicMessageLink', params: getPublicMessageLink) => Promise<PublicMessageLink>)
  | ((method: 'getMessageLink', params: getMessageLink) => Promise<HttpUrl>)
  | ((method: 'sendMessage', params: sendMessage) => Promise<Message>)
  | ((method: 'sendMessageAlbum', params: sendMessageAlbum) => Promise<Messages>)
  | ((method: 'sendBotStartMessage', params: sendBotStartMessage) => Promise<Message>)
  | ((method: 'sendInlineQueryResultMessage', params: sendInlineQueryResultMessage) => Promise<Message>)
  | ((method: 'forwardMessages', params: forwardMessages) => Promise<Messages>)
  | ((method: 'sendChatSetTtlMessage', params: sendChatSetTtlMessage) => Promise<Message>)
  | ((method: 'sendChatScreenshotTakenNotification', params: sendChatScreenshotTakenNotification) => Promise<Ok>)
  | ((method: 'addLocalMessage', params: addLocalMessage) => Promise<Message>)
  | ((method: 'deleteMessages', params: deleteMessages) => Promise<Ok>)
  | ((method: 'deleteChatMessagesFromUser', params: deleteChatMessagesFromUser) => Promise<Ok>)
  | ((method: 'editMessageText', params: editMessageText) => Promise<Message>)
  | ((method: 'editMessageLiveLocation', params: editMessageLiveLocation) => Promise<Message>)
  | ((method: 'editMessageMedia', params: editMessageMedia) => Promise<Message>)
  | ((method: 'editMessageCaption', params: editMessageCaption) => Promise<Message>)
  | ((method: 'editMessageReplyMarkup', params: editMessageReplyMarkup) => Promise<Message>)
  | ((method: 'editInlineMessageText', params: editInlineMessageText) => Promise<Ok>)
  | ((method: 'editInlineMessageLiveLocation', params: editInlineMessageLiveLocation) => Promise<Ok>)
  | ((method: 'editInlineMessageMedia', params: editInlineMessageMedia) => Promise<Ok>)
  | ((method: 'editInlineMessageCaption', params: editInlineMessageCaption) => Promise<Ok>)
  | ((method: 'editInlineMessageReplyMarkup', params: editInlineMessageReplyMarkup) => Promise<Ok>)
  | ((method: 'getTextEntities', params: getTextEntities) => Promise<TextEntities>)
  | ((method: 'parseTextEntities', params: parseTextEntities) => Promise<FormattedText>)
  | ((method: 'getFileMimeType', params: getFileMimeType) => Promise<Text>)
  | ((method: 'getFileExtension', params: getFileExtension) => Promise<Text>)
  | ((method: 'cleanFileName', params: cleanFileName) => Promise<Text>)
  | ((method: 'getLanguagePackString', params: getLanguagePackString) => Promise<LanguagePackStringValue>)
  | ((method: 'getJsonValue', params: getJsonValue) => Promise<JsonValue>)
  | ((method: 'getJsonString', params: getJsonString) => Promise<Text>)
  | ((method: 'setPollAnswer', params: setPollAnswer) => Promise<Ok>)
  | ((method: 'stopPoll', params: stopPoll) => Promise<Ok>)
  | ((method: 'getInlineQueryResults', params: getInlineQueryResults) => Promise<InlineQueryResults>)
  | ((method: 'answerInlineQuery', params: answerInlineQuery) => Promise<Ok>)
  | ((method: 'getCallbackQueryAnswer', params: getCallbackQueryAnswer) => Promise<CallbackQueryAnswer>)
  | ((method: 'answerCallbackQuery', params: answerCallbackQuery) => Promise<Ok>)
  | ((method: 'answerShippingQuery', params: answerShippingQuery) => Promise<Ok>)
  | ((method: 'answerPreCheckoutQuery', params: answerPreCheckoutQuery) => Promise<Ok>)
  | ((method: 'setGameScore', params: setGameScore) => Promise<Message>)
  | ((method: 'setInlineGameScore', params: setInlineGameScore) => Promise<Ok>)
  | ((method: 'getGameHighScores', params: getGameHighScores) => Promise<GameHighScores>)
  | ((method: 'getInlineGameHighScores', params: getInlineGameHighScores) => Promise<GameHighScores>)
  | ((method: 'deleteChatReplyMarkup', params: deleteChatReplyMarkup) => Promise<Ok>)
  | ((method: 'sendChatAction', params: sendChatAction) => Promise<Ok>)
  | ((method: 'openChat', params: openChat) => Promise<Ok>)
  | ((method: 'closeChat', params: closeChat) => Promise<Ok>)
  | ((method: 'viewMessages', params: viewMessages) => Promise<Ok>)
  | ((method: 'openMessageContent', params: openMessageContent) => Promise<Ok>)
  | ((method: 'readAllChatMentions', params: readAllChatMentions) => Promise<Ok>)
  | ((method: 'createPrivateChat', params: createPrivateChat) => Promise<Chat>)
  | ((method: 'createBasicGroupChat', params: createBasicGroupChat) => Promise<Chat>)
  | ((method: 'createSupergroupChat', params: createSupergroupChat) => Promise<Chat>)
  | ((method: 'createSecretChat', params: createSecretChat) => Promise<Chat>)
  | ((method: 'createNewBasicGroupChat', params: createNewBasicGroupChat) => Promise<Chat>)
  | ((method: 'createNewSupergroupChat', params: createNewSupergroupChat) => Promise<Chat>)
  | ((method: 'createNewSecretChat', params: createNewSecretChat) => Promise<Chat>)
  | ((method: 'upgradeBasicGroupChatToSupergroupChat', params: upgradeBasicGroupChatToSupergroupChat) => Promise<Chat>)
  | ((method: 'setChatTitle', params: setChatTitle) => Promise<Ok>)
  | ((method: 'setChatPhoto', params: setChatPhoto) => Promise<Ok>)
  | ((method: 'setChatDraftMessage', params: setChatDraftMessage) => Promise<Ok>)
  | ((method: 'setChatNotificationSettings', params: setChatNotificationSettings) => Promise<Ok>)
  | ((method: 'toggleChatIsPinned', params: toggleChatIsPinned) => Promise<Ok>)
  | ((method: 'toggleChatIsMarkedAsUnread', params: toggleChatIsMarkedAsUnread) => Promise<Ok>)
  | ((method: 'toggleChatDefaultDisableNotification', params: toggleChatDefaultDisableNotification) => Promise<Ok>)
  | ((method: 'setChatClientData', params: setChatClientData) => Promise<Ok>)
  | ((method: 'pinChatMessage', params: pinChatMessage) => Promise<Ok>)
  | ((method: 'unpinChatMessage', params: unpinChatMessage) => Promise<Ok>)
  | ((method: 'joinChat', params: joinChat) => Promise<Ok>)
  | ((method: 'leaveChat', params: leaveChat) => Promise<Ok>)
  | ((method: 'addChatMember', params: addChatMember) => Promise<Ok>)
  | ((method: 'addChatMembers', params: addChatMembers) => Promise<Ok>)
  | ((method: 'setChatMemberStatus', params: setChatMemberStatus) => Promise<Ok>)
  | ((method: 'getChatMember', params: getChatMember) => Promise<ChatMember>)
  | ((method: 'searchChatMembers', params: searchChatMembers) => Promise<ChatMembers>)
  | ((method: 'getChatAdministrators', params: getChatAdministrators) => Promise<Users>)
  | ((method: 'clearAllDraftMessages', params: clearAllDraftMessages) => Promise<Ok>)
  | ((method: 'getChatNotificationSettingsExceptions', params: getChatNotificationSettingsExceptions) => Promise<Chats>)
  | ((method: 'getScopeNotificationSettings', params: getScopeNotificationSettings) => Promise<ScopeNotificationSettings>)
  | ((method: 'setScopeNotificationSettings', params: setScopeNotificationSettings) => Promise<Ok>)
  | ((method: 'resetAllNotificationSettings', params: resetAllNotificationSettings) => Promise<Ok>)
  | ((method: 'setPinnedChats', params: setPinnedChats) => Promise<Ok>)
  | ((method: 'downloadFile', params: downloadFile) => Promise<File>)
  | ((method: 'getFileDownloadedPrefixSize', params: getFileDownloadedPrefixSize) => Promise<Count>)
  | ((method: 'cancelDownloadFile', params: cancelDownloadFile) => Promise<Ok>)
  | ((method: 'uploadFile', params: uploadFile) => Promise<File>)
  | ((method: 'cancelUploadFile', params: cancelUploadFile) => Promise<Ok>)
  | ((method: 'writeGeneratedFilePart', params: writeGeneratedFilePart) => Promise<Ok>)
  | ((method: 'setFileGenerationProgress', params: setFileGenerationProgress) => Promise<Ok>)
  | ((method: 'finishFileGeneration', params: finishFileGeneration) => Promise<Ok>)
  | ((method: 'readFilePart', params: readFilePart) => Promise<FilePart>)
  | ((method: 'deleteFile', params: deleteFile) => Promise<Ok>)
  | ((method: 'generateChatInviteLink', params: generateChatInviteLink) => Promise<ChatInviteLink>)
  | ((method: 'checkChatInviteLink', params: checkChatInviteLink) => Promise<ChatInviteLinkInfo>)
  | ((method: 'joinChatByInviteLink', params: joinChatByInviteLink) => Promise<Chat>)
  | ((method: 'createCall', params: createCall) => Promise<CallId>)
  | ((method: 'acceptCall', params: acceptCall) => Promise<Ok>)
  | ((method: 'discardCall', params: discardCall) => Promise<Ok>)
  | ((method: 'sendCallRating', params: sendCallRating) => Promise<Ok>)
  | ((method: 'sendCallDebugInformation', params: sendCallDebugInformation) => Promise<Ok>)
  | ((method: 'blockUser', params: blockUser) => Promise<Ok>)
  | ((method: 'unblockUser', params: unblockUser) => Promise<Ok>)
  | ((method: 'getBlockedUsers', params: getBlockedUsers) => Promise<Users>)
  | ((method: 'importContacts', params: importContacts) => Promise<ImportedContacts>)
  | ((method: 'getContacts', params: getContacts) => Promise<Users>)
  | ((method: 'searchContacts', params: searchContacts) => Promise<Users>)
  | ((method: 'removeContacts', params: removeContacts) => Promise<Ok>)
  | ((method: 'getImportedContactCount', params: getImportedContactCount) => Promise<Count>)
  | ((method: 'changeImportedContacts', params: changeImportedContacts) => Promise<ImportedContacts>)
  | ((method: 'clearImportedContacts', params: clearImportedContacts) => Promise<Ok>)
  | ((method: 'getUserProfilePhotos', params: getUserProfilePhotos) => Promise<UserProfilePhotos>)
  | ((method: 'getStickers', params: getStickers) => Promise<Stickers>)
  | ((method: 'searchStickers', params: searchStickers) => Promise<Stickers>)
  | ((method: 'getInstalledStickerSets', params: getInstalledStickerSets) => Promise<StickerSets>)
  | ((method: 'getArchivedStickerSets', params: getArchivedStickerSets) => Promise<StickerSets>)
  | ((method: 'getTrendingStickerSets', params: getTrendingStickerSets) => Promise<StickerSets>)
  | ((method: 'getAttachedStickerSets', params: getAttachedStickerSets) => Promise<StickerSets>)
  | ((method: 'getStickerSet', params: getStickerSet) => Promise<StickerSet>)
  | ((method: 'searchStickerSet', params: searchStickerSet) => Promise<StickerSet>)
  | ((method: 'searchInstalledStickerSets', params: searchInstalledStickerSets) => Promise<StickerSets>)
  | ((method: 'searchStickerSets', params: searchStickerSets) => Promise<StickerSets>)
  | ((method: 'changeStickerSet', params: changeStickerSet) => Promise<Ok>)
  | ((method: 'viewTrendingStickerSets', params: viewTrendingStickerSets) => Promise<Ok>)
  | ((method: 'reorderInstalledStickerSets', params: reorderInstalledStickerSets) => Promise<Ok>)
  | ((method: 'getRecentStickers', params: getRecentStickers) => Promise<Stickers>)
  | ((method: 'addRecentSticker', params: addRecentSticker) => Promise<Stickers>)
  | ((method: 'removeRecentSticker', params: removeRecentSticker) => Promise<Ok>)
  | ((method: 'clearRecentStickers', params: clearRecentStickers) => Promise<Ok>)
  | ((method: 'getFavoriteStickers', params: getFavoriteStickers) => Promise<Stickers>)
  | ((method: 'addFavoriteSticker', params: addFavoriteSticker) => Promise<Ok>)
  | ((method: 'removeFavoriteSticker', params: removeFavoriteSticker) => Promise<Ok>)
  | ((method: 'getStickerEmojis', params: getStickerEmojis) => Promise<StickerEmojis>)
  | ((method: 'getSavedAnimations', params: getSavedAnimations) => Promise<Animations>)
  | ((method: 'addSavedAnimation', params: addSavedAnimation) => Promise<Ok>)
  | ((method: 'removeSavedAnimation', params: removeSavedAnimation) => Promise<Ok>)
  | ((method: 'getRecentInlineBots', params: getRecentInlineBots) => Promise<Users>)
  | ((method: 'searchHashtags', params: searchHashtags) => Promise<Hashtags>)
  | ((method: 'removeRecentHashtag', params: removeRecentHashtag) => Promise<Ok>)
  | ((method: 'getWebPagePreview', params: getWebPagePreview) => Promise<WebPage>)
  | ((method: 'getWebPageInstantView', params: getWebPageInstantView) => Promise<WebPageInstantView>)
  | ((method: 'setProfilePhoto', params: setProfilePhoto) => Promise<Ok>)
  | ((method: 'deleteProfilePhoto', params: deleteProfilePhoto) => Promise<Ok>)
  | ((method: 'setName', params: setName) => Promise<Ok>)
  | ((method: 'setBio', params: setBio) => Promise<Ok>)
  | ((method: 'setUsername', params: setUsername) => Promise<Ok>)
  | ((method: 'changePhoneNumber', params: changePhoneNumber) => Promise<AuthenticationCodeInfo>)
  | ((method: 'resendChangePhoneNumberCode', params: resendChangePhoneNumberCode) => Promise<AuthenticationCodeInfo>)
  | ((method: 'checkChangePhoneNumberCode', params: checkChangePhoneNumberCode) => Promise<Ok>)
  | ((method: 'getActiveSessions', params: getActiveSessions) => Promise<Sessions>)
  | ((method: 'terminateSession', params: terminateSession) => Promise<Ok>)
  | ((method: 'terminateAllOtherSessions', params: terminateAllOtherSessions) => Promise<Ok>)
  | ((method: 'getConnectedWebsites', params: getConnectedWebsites) => Promise<ConnectedWebsites>)
  | ((method: 'disconnectWebsite', params: disconnectWebsite) => Promise<Ok>)
  | ((method: 'disconnectAllWebsites', params: disconnectAllWebsites) => Promise<Ok>)
  | ((method: 'toggleBasicGroupAdministrators', params: toggleBasicGroupAdministrators) => Promise<Ok>)
  | ((method: 'setSupergroupUsername', params: setSupergroupUsername) => Promise<Ok>)
  | ((method: 'setSupergroupStickerSet', params: setSupergroupStickerSet) => Promise<Ok>)
  | ((method: 'toggleSupergroupInvites', params: toggleSupergroupInvites) => Promise<Ok>)
  | ((method: 'toggleSupergroupSignMessages', params: toggleSupergroupSignMessages) => Promise<Ok>)
  | ((method: 'toggleSupergroupIsAllHistoryAvailable', params: toggleSupergroupIsAllHistoryAvailable) => Promise<Ok>)
  | ((method: 'setSupergroupDescription', params: setSupergroupDescription) => Promise<Ok>)
  | ((method: 'reportSupergroupSpam', params: reportSupergroupSpam) => Promise<Ok>)
  | ((method: 'getSupergroupMembers', params: getSupergroupMembers) => Promise<ChatMembers>)
  | ((method: 'deleteSupergroup', params: deleteSupergroup) => Promise<Ok>)
  | ((method: 'closeSecretChat', params: closeSecretChat) => Promise<Ok>)
  | ((method: 'getChatEventLog', params: getChatEventLog) => Promise<ChatEvents>)
  | ((method: 'getPaymentForm', params: getPaymentForm) => Promise<PaymentForm>)
  | ((method: 'validateOrderInfo', params: validateOrderInfo) => Promise<ValidatedOrderInfo>)
  | ((method: 'sendPaymentForm', params: sendPaymentForm) => Promise<PaymentResult>)
  | ((method: 'getPaymentReceipt', params: getPaymentReceipt) => Promise<PaymentReceipt>)
  | ((method: 'getSavedOrderInfo', params: getSavedOrderInfo) => Promise<OrderInfo>)
  | ((method: 'deleteSavedOrderInfo', params: deleteSavedOrderInfo) => Promise<Ok>)
  | ((method: 'deleteSavedCredentials', params: deleteSavedCredentials) => Promise<Ok>)
  | ((method: 'getSupportUser', params: getSupportUser) => Promise<User>)
  | ((method: 'getWallpapers', params: getWallpapers) => Promise<Wallpapers>)
  | ((method: 'getLocalizationTargetInfo', params: getLocalizationTargetInfo) => Promise<LocalizationTargetInfo>)
  | ((method: 'getLanguagePackInfo', params: getLanguagePackInfo) => Promise<LanguagePackInfo>)
  | ((method: 'getLanguagePackStrings', params: getLanguagePackStrings) => Promise<LanguagePackStrings>)
  | ((method: 'synchronizeLanguagePack', params: synchronizeLanguagePack) => Promise<Ok>)
  | ((method: 'addCustomServerLanguagePack', params: addCustomServerLanguagePack) => Promise<Ok>)
  | ((method: 'setCustomLanguagePack', params: setCustomLanguagePack) => Promise<Ok>)
  | ((method: 'editCustomLanguagePackInfo', params: editCustomLanguagePackInfo) => Promise<Ok>)
  | ((method: 'setCustomLanguagePackString', params: setCustomLanguagePackString) => Promise<Ok>)
  | ((method: 'deleteLanguagePack', params: deleteLanguagePack) => Promise<Ok>)
  | ((method: 'registerDevice', params: registerDevice) => Promise<PushReceiverId>)
  | ((method: 'processPushNotification', params: processPushNotification) => Promise<Ok>)
  | ((method: 'getPushReceiverId', params: getPushReceiverId) => Promise<PushReceiverId>)
  | ((method: 'getRecentlyVisitedTMeUrls', params: getRecentlyVisitedTMeUrls) => Promise<TMeUrls>)
  | ((method: 'setUserPrivacySettingRules', params: setUserPrivacySettingRules) => Promise<Ok>)
  | ((method: 'getUserPrivacySettingRules', params: getUserPrivacySettingRules) => Promise<UserPrivacySettingRules>)
  | ((method: 'getOption', params: getOption) => Promise<OptionValue>)
  | ((method: 'setOption', params: setOption) => Promise<Ok>)
  | ((method: 'setAccountTtl', params: setAccountTtl) => Promise<Ok>)
  | ((method: 'getAccountTtl', params: getAccountTtl) => Promise<AccountTtl>)
  | ((method: 'deleteAccount', params: deleteAccount) => Promise<Ok>)
  | ((method: 'getChatReportSpamState', params: getChatReportSpamState) => Promise<ChatReportSpamState>)
  | ((method: 'changeChatReportSpamState', params: changeChatReportSpamState) => Promise<Ok>)
  | ((method: 'reportChat', params: reportChat) => Promise<Ok>)
  | ((method: 'getChatStatisticsUrl', params: getChatStatisticsUrl) => Promise<HttpUrl>)
  | ((method: 'getStorageStatistics', params: getStorageStatistics) => Promise<StorageStatistics>)
  | ((method: 'getStorageStatisticsFast', params: getStorageStatisticsFast) => Promise<StorageStatisticsFast>)
  | ((method: 'getDatabaseStatistics', params: getDatabaseStatistics) => Promise<DatabaseStatistics>)
  | ((method: 'optimizeStorage', params: optimizeStorage) => Promise<StorageStatistics>)
  | ((method: 'setNetworkType', params: setNetworkType) => Promise<Ok>)
  | ((method: 'getNetworkStatistics', params: getNetworkStatistics) => Promise<NetworkStatistics>)
  | ((method: 'addNetworkStatistics', params: addNetworkStatistics) => Promise<Ok>)
  | ((method: 'resetNetworkStatistics', params: resetNetworkStatistics) => Promise<Ok>)
  | ((method: 'getPassportElement', params: getPassportElement) => Promise<PassportElement>)
  | ((method: 'getAllPassportElements', params: getAllPassportElements) => Promise<PassportElements>)
  | ((method: 'setPassportElement', params: setPassportElement) => Promise<PassportElement>)
  | ((method: 'deletePassportElement', params: deletePassportElement) => Promise<Ok>)
  | ((method: 'setPassportElementErrors', params: setPassportElementErrors) => Promise<Ok>)
  | ((method: 'getPreferredCountryLanguage', params: getPreferredCountryLanguage) => Promise<Text>)
  | ((method: 'sendPhoneNumberVerificationCode', params: sendPhoneNumberVerificationCode) => Promise<AuthenticationCodeInfo>)
  | ((method: 'resendPhoneNumberVerificationCode', params: resendPhoneNumberVerificationCode) => Promise<AuthenticationCodeInfo>)
  | ((method: 'checkPhoneNumberVerificationCode', params: checkPhoneNumberVerificationCode) => Promise<Ok>)
  | ((method: 'sendEmailAddressVerificationCode', params: sendEmailAddressVerificationCode) => Promise<EmailAddressAuthenticationCodeInfo>)
  | ((method: 'resendEmailAddressVerificationCode', params: resendEmailAddressVerificationCode) => Promise<EmailAddressAuthenticationCodeInfo>)
  | ((method: 'checkEmailAddressVerificationCode', params: checkEmailAddressVerificationCode) => Promise<Ok>)
  | ((method: 'getPassportAuthorizationForm', params: getPassportAuthorizationForm) => Promise<PassportAuthorizationForm>)
  | ((method: 'getPassportAuthorizationFormAvailableElements', params: getPassportAuthorizationFormAvailableElements) => Promise<PassportElementsWithErrors>)
  | ((method: 'sendPassportAuthorizationForm', params: sendPassportAuthorizationForm) => Promise<Ok>)
  | ((method: 'sendPhoneNumberConfirmationCode', params: sendPhoneNumberConfirmationCode) => Promise<AuthenticationCodeInfo>)
  | ((method: 'resendPhoneNumberConfirmationCode', params: resendPhoneNumberConfirmationCode) => Promise<AuthenticationCodeInfo>)
  | ((method: 'checkPhoneNumberConfirmationCode', params: checkPhoneNumberConfirmationCode) => Promise<Ok>)
  | ((method: 'setBotUpdatesStatus', params: setBotUpdatesStatus) => Promise<Ok>)
  | ((method: 'uploadStickerFile', params: uploadStickerFile) => Promise<File>)
  | ((method: 'createNewStickerSet', params: createNewStickerSet) => Promise<StickerSet>)
  | ((method: 'addStickerToSet', params: addStickerToSet) => Promise<StickerSet>)
  | ((method: 'setStickerPositionInSet', params: setStickerPositionInSet) => Promise<Ok>)
  | ((method: 'removeStickerFromSet', params: removeStickerFromSet) => Promise<Ok>)
  | ((method: 'getMapThumbnailFile', params: getMapThumbnailFile) => Promise<File>)
  | ((method: 'acceptTermsOfService', params: acceptTermsOfService) => Promise<Ok>)
  | ((method: 'sendCustomRequest', params: sendCustomRequest) => Promise<CustomRequestResult>)
  | ((method: 'answerCustomQuery', params: answerCustomQuery) => Promise<Ok>)
  | ((method: 'setAlarm', params: setAlarm) => Promise<Ok>)
  | ((method: 'getCountryCode', params: getCountryCode) => Promise<Text>)
  | ((method: 'getInviteText', params: getInviteText) => Promise<Text>)
  | ((method: 'getDeepLinkInfo', params: getDeepLinkInfo) => Promise<DeepLinkInfo>)
  | ((method: 'getApplicationConfig', params: getApplicationConfig) => Promise<JsonValue>)
  | ((method: 'saveApplicationLogEvent', params: saveApplicationLogEvent) => Promise<Ok>)
  | ((method: 'addProxy', params: addProxy) => Promise<Proxy>)
  | ((method: 'editProxy', params: editProxy) => Promise<Proxy>)
  | ((method: 'enableProxy', params: enableProxy) => Promise<Ok>)
  | ((method: 'disableProxy', params: disableProxy) => Promise<Ok>)
  | ((method: 'removeProxy', params: removeProxy) => Promise<Ok>)
  | ((method: 'getProxies', params: getProxies) => Promise<Proxies>)
  | ((method: 'getProxyLink', params: getProxyLink) => Promise<Text>)
  | ((method: 'pingProxy', params: pingProxy) => Promise<Seconds>)
  | ((method: 'setLogStream', params: setLogStream) => Promise<Ok>)
  | ((method: 'getLogStream', params: getLogStream) => Promise<LogStream>)
  | ((method: 'setLogVerbosityLevel', params: setLogVerbosityLevel) => Promise<Ok>)
  | ((method: 'getLogVerbosityLevel', params: getLogVerbosityLevel) => Promise<LogVerbosityLevel>)
  | ((method: 'getLogTags', params: getLogTags) => Promise<LogTags>)
  | ((method: 'setLogTagVerbosityLevel', params: setLogTagVerbosityLevel) => Promise<Ok>)
  | ((method: 'getLogTagVerbosityLevel', params: getLogTagVerbosityLevel) => Promise<LogVerbosityLevel>)
  | ((method: 'addLogMessage', params: addLogMessage) => Promise<Ok>)
  | ((method: 'testCallEmpty', params: testCallEmpty) => Promise<Ok>)
  | ((method: 'testCallString', params: testCallString) => Promise<TestString>)
  | ((method: 'testCallBytes', params: testCallBytes) => Promise<TestBytes>)
  | ((method: 'testCallVectorInt', params: testCallVectorInt) => Promise<TestVectorInt>)
  | ((method: 'testCallVectorIntObject', params: testCallVectorIntObject) => Promise<TestVectorIntObject>)
  | ((method: 'testCallVectorString', params: testCallVectorString) => Promise<TestVectorString>)
  | ((method: 'testCallVectorStringObject', params: testCallVectorStringObject) => Promise<TestVectorStringObject>)
  | ((method: 'testSquareInt', params: testSquareInt) => Promise<TestInt>)
  | ((method: 'testNetwork', params: testNetwork) => Promise<Ok>)
  | ((method: 'testGetDifference', params: testGetDifference) => Promise<Ok>)
  | ((method: 'testUseUpdate', params: testUseUpdate) => Promise<Update>)
  | ((method: 'testUseError', params: testUseError) => Promise<Error>)

export as namespace TdTypes;
